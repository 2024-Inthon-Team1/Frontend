...
//           messageList[index + 1].userId !== msg.userId;
...
//           <div key={index} className={`flex ${justifyClass} items-center`}>
//             {isCurrentUser && isLastMessageFromUser ? (
//               <div className="text-xs text-gray-400 mr-0.5 self-end mt-0">
//                 {' '}
...
//               <div className="rounded-full h-6 w-6 bg-gray-400 mr-2"></div>
//             ) : !isCurrentUser ? (
//               <div className="rounded-full h-7 w-7 mr-2"></div>
//             ) : null}
//             <div
//               className={`inline-block max-w-56 rounded-3xl ${bgColor} ${textColor} p-3 mt-1 text-sm leading-tight whitespace-pre-wrap text-start`}
//             >
//               {msg.message}
//             </div>
//             {!isCurrentUser && isLastMessageFromUser ? (
//               <div className="text-xs text-gray-400 ml-0.5 self-end mt-0">
//                 {' '}
//                 {timestamp.toLocaleTimeString([], {
//                   hour: '2-digit',
//                   minute: '2-digit',
